 ...
 function [txq,In_out_List] = simulate_diffusion_distribution_mask(Cells_mask,Voxel_dim,Diff)
...
[In_out_List(:,1)] = Collision_ToolBox.Collision_Detection_Mask(Cells_mask, squeeze(xt(:,:,1)),Resolution);
...
for cpt_t=2:1:(Diff.dur+1)
    ...
    while List_coll
        ...
        % Collision detection
        [tmp_List] = Collision_ToolBox.Collision_Detection_Mask(Cells_mask, squeeze(xt(:,:,cpt_t)),Resolution);
