...
World.Voxel_pixel=[500 500 500];
World.Resolution=World.Voxel./World.Voxel_pixel;
...
%% Simulate a cell structure and create a mask from it 
...
Cells_mask=Cellule_ToolBox.Cells_2_Mask(Cells,World.Voxel,World.Resolution);
